...
#define DXL_MAX_SYNCH_BUFFER_SIZE   250
...
public:
  ...
  int syncWritePosition(unsigned char IDs[], int positions[], int speeds[], int numServos);	
	...
	void action(void);
	void bulkReadPosition(ServoPosition* positions, unsigned char* IDs, int numServos);
